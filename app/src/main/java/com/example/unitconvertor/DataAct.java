...
public class DataAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter adapter1 = ArrayAdapter.createFromResource(this,R.array.Data,R.layout.spinner_styling);
        spinnerr1.setAdapter(adapter1);
        ArrayAdapter adapter2 = ArrayAdapter.createFromResource(this,R.array.Data,R.layout.spinner_styling);
            ...
            switch(option1){
                case 0:
                    switch(option2) {
                        case 0: temp = value;
                            break;
                        case 1: temp = value / 1000;
                            break;
                        case 2: temp = value / 1000000;
                            break;
                        case 3: temp = value / 1000000000;
                            break;
                        case 4: temp = value / 1000000000000l;
                            break;
                    }
                    break;
                case 1:
                    switch(option2) {
                        case 0: temp = value * 1000;
                            break;
                        case 1: temp = value;
                            break;
                        case 2: temp = value/1000;
                            break;
                        case 3: temp = value/1000000;
                            break;
                        case 4: temp = value / 1000000000;
                            break;
                    }
                    break;
                case 2:
                    switch(option2) {
                        case 0: temp = value * 1000000;
                            break;
                        case 1: temp = value * 1000;
                            break;
                        case 2: temp = value;
                            break;
                        case 3: temp = value/1000;
                            break;
                        case 4: temp = value/1000000;
                            break;
                    }
                    break;
                case 3:
                    switch(option2) {
                        case 0: temp = value * 1000000000;
                            break;
                        case 1: temp = value * 1000000;
                            break;
                        case 2: temp = value * 1000;
                            break;
                        case 3: temp = value;
                            break;
                        case 4: temp = value / 1000;
                            break;
                    }
                    break;
                case 4:
                    switch(option2) {
                        case 0: temp = value * 1000000000000l;
                            break;
                        case 1: temp = value * 1000000000;
                            break;
                        case 2:temp = value * 1000000;
                            break;
                        case 3: temp = value * 1000;
